...
const defaultLayout = "French (FR)";
const byName = {
    "French (FR)": {
        name_short: "FR",
        description: "AZERTY - Full",
        comment: "Like physical AZERTY FR keyboard",
        keys: [
            [
            ...
            [
                ...
                { keytype: "normal", label: "&", labelShift: "1", shape: "normal", keycode: 2 },
                { keytype: "normal", label: "é", labelShift: "2", shape: "normal", keycode: 3 },
                { keytype: "normal", label: "\"", labelShift: "3", shape: "normal", keycode: 4 },
                { keytype: "normal", label: "'", labelShift: "4", shape: "normal", keycode: 5 },
                { keytype: "normal", label: "(", labelShift: "5", shape: "normal", keycode: 6 },
                { keytype: "normal", label: "-", labelShift: "6", shape: "normal", keycode: 7 },
                { keytype: "normal", label: "è", labelShift: "7", shape: "normal", keycode: 8 },
                { keytype: "normal", label: "_", labelShift: "8", shape: "normal", keycode: 9 },
                { keytype: "normal", label: "ç", labelShift: "9", shape: "normal", keycode: 10 },
                { keytype: "normal", label: "à", labelShift: "0", shape: "normal", keycode: 11 },
            ...
            [
                ...
                { keytype: "normal", label: "a", labelShift: "A", shape: "normal", keycode: 16 },
                { keytype: "normal", label: "z", labelShift: "Z", shape: "normal", keycode: 17 },
                ...
                { keytype: "normal", label: "*", shape: "expand", keycode: 43 }
            ],
            [
                { keytype: "spacer", shape: "empty" },
                { keytype: "spacer", shape: "empty" },
                { keytype: "normal", label: "q", labelShift: "Q", shape: "normal", keycode: 30 },
                ...
                { keytype: "normal", label: "m", labelShift: "M", shape: "normal", keycode: 39 },
                { keytype: "normal", label: "ù", shape: "normal", keycode: 40 },
                { keytype: "normal", label: "Enter", shape: "expand", keycode: 28 }
            ],
            [
                { keytype: "modkey", label: "Shift", labelCaps: "Caps", shape: "shift", keycode: 42 },
                { keytype: "normal", label: "w", labelShift: "W", shape: "normal", keycode: 44 },
                ...
                { keytype: "normal", label: ",", labelShift: "?", shape: "normal", keycode: 50 },
                ...
                { keytype: "modkey", label: "Shift", labelCaps: "Caps", shape: "expand", keycode: 54 }
            ],
            [
